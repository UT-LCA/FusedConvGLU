...
class ConvGLUTest(nn.Module):
    ...
    def forward(self, input):
        ...
        #                          self.bias, self.padding[0])
        #return conv_glu_cuda.forward(input.contiguous(), self.weight,
        #                          self.bias, self.padding[0])
        return F.glu(conv_glu_cuda.forward(input.contiguous(), self.weight,
                                          self.bias, self.padding[0]), dim=0)
